...
export MOBEL_BUCKET_MUTIGPU=gs://dontbeturtle_multigpu
export MOBEL_BUCKET2=gs://bucket_aisolab
export MODEL_BUCKET3=gs://dontbeturtle_ckpt3/
export MOBEL_BUCKET4=gs://bucket_yglee
...
gsutil acl ch -u ${YOUR_SERVICE_NAME}:READER ${MOBEL_BUCKET_MUTIGPU}
gsutil acl ch -u ${YOUR_SERVICE_NAME}:WRITER ${MOBEL_BUCKET_MUTIGPU}
